...
module.exports = {
	/**
 * Return blocks shares for miner
 **/
	minerByBlock:function(urlParts, sendData){
        ...
        redisClient.zrange(config.coin + ':block_worker_shares:'+id, height, height,function(err, results){
	...
	miner:function(urlParts, sendData){
	    ...
	    redisClient.zrevrangebyscore(
                config.coin + ':block_worker_shares:'+id,
                '(' + height,
                '-inf',
                'WITHSCORES',
                'LIMIT',
