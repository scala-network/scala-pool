...
function getPoolStats(callback) {
    global.Cache.readCallback('getPoolStats',writecallback => {
...
function getNetworkDifficulty(callback) {
	redisClient.hget(global.config.coin+":stats","difficulty", callback);
}
